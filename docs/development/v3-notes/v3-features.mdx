...
mcp.disable(name="dangerous_tool", components=["tool"])

# Disable by tag
mcp.disable(tags={"admin"})

# Disable by version
mcp.disable(name="old_tool", version="1.0", components=["tool"])
...
mcp.enable(name="safe_tool")  # safe_tool is visible despite internal tag
```
