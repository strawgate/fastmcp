...
<Note>
FastMCP 3.0 is currently in beta. Install by specifying the version explicitly.
</Note>
...
<Warning>
Avoid using `pip install --pre` as it enables prereleases for all dependencies, which may install incompatible versions of packages like httpx.
</Warning>
