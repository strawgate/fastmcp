...
#### `get_routes` <sup><a href="https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/server/auth/providers/supabase.py#L115" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
