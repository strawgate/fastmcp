...
### `compress_schema` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/src/fastmcp/utilities/json_schema.py#L448" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
