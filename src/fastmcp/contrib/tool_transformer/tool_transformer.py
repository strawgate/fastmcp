...
def _apply_parameter_overrides(
    ...
    for param_name, param_override in parameter_overrides.items():
        transformed_schema = param_override.combine_into_schema(
            param_name, transformed_schema
        )
...
def transform_tool(
    ...
    *,
    ...
    description: Annotated[
        str | None, "The description for the transformed tool."
    ] = None,
    ...
    parameter_overrides: Annotated[
        dict[str, ToolParameterOverride], "Parameter overrides for the tool."
    ]
    | None = None,
    ...
    transformed_parameters = _apply_hook_parameters(
        schema=tool.parameters, hook_parameters=hook_parameters
    )
